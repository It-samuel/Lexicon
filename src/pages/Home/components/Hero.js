...
export const Hero = () => {
  return (
    <section className="flex flex-col lg:flex-row dark:border-gray-700 items-center m-4">
        <div className="text my-5">
            <h1 className="text-5xl font-bold  dark:text-slate-100 mb-3" >The Ultimate Tech eBook Store</h1>
            <p className="text-2xl my-7 px-1 dark:text-slate-300">Lexicon is the world's most popular and authoritative source for computer science ebooks. Find ratings and access to the newest books digitally.</p>
