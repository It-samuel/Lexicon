...
export const Testimonials = () => {
    return (
      <section className='my-20 ml-30 mr-30' >
          <h1 className="text-2xl text-center font-semibold dark:text-slate-100 mb-5 underline underline-offset-8">Reviews About Lexicon</h1>    
